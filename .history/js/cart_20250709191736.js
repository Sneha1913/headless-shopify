...
class CartItems extends HTMLElement {
  ...
  onCartUpdate(event) {
    ...
    const cartDrawerRecommendation = document.querySelector(`#CartDrawerRecommendation-${sectionId}`); //Custom
    ...
    if (cartDrawer) {
      ...
      const cartDrawerRecommendationUpdate = sectionToRender.querySelector(`#CartDrawerRecommendation-${sectionId}`);//Custom
      ...
      //Custom
      if (cartDrawerRecommendationUpdate) {
        cartDrawerRecommendation.innerHTML = cartDrawerRecommendationUpdate.innerHTML;
      }
